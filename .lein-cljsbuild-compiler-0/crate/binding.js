...
var key = cljs.core.nth.call(null,vec__3743,0,null);
...
var self__ = this;
return cljs.core.add_watch.call(null,self__.notif,cljs.core.gensym.call(null,"bound-coll"),(function (_,___$1,___$2,p__3745){
var vec__3746 = p__3745;
var event = cljs.core.nth.call(null,vec__3746,0,null);
var el = cljs.core.nth.call(null,vec__3746,1,null);
var v = cljs.core.nth.call(null,vec__3746,2,null);
...
__GT_path.cljs$lang$applyTo = (function (arglist__3747){
var bc = cljs.core.first(arglist__3747);
var segs = cljs.core.rest(arglist__3747);
...
var G__3750 = cljs.core.seq.call(null,added);
while(true){
if(G__3750)
{var a = cljs.core.first.call(null,G__3750);
crate.binding.bc_add.call(null,bc,a,a);
{
var G__3752 = cljs.core.next.call(null,G__3750);
G__3750 = G__3752;
continue;
}
} else
...
var G__3751 = cljs.core.seq.call(null,removed);
while(true){
if(G__3751)
{var r = cljs.core.first.call(null,G__3751);
...
var bound_coll__delegate = function (atm,p__3754){
var vec__3757 = p__3754;
var path = cljs.core.nth.call(null,vec__3757,0,null);
var opts = cljs.core.nth.call(null,vec__3757,1,null);
var vec__3758 = (cljs.core.truth_(opts)?cljs.core.PersistentVector.fromArray([path,opts], true):cljs.core.PersistentVector.fromArray([null,path], true));
var path__$1 = cljs.core.nth.call(null,vec__3758,0,null);
var opts__$1 = cljs.core.nth.call(null,vec__3758,1,null);
...
var p__3754 = null;
if (goog.isDef(var_args)) {
  p__3754 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);
} 
return bound_coll__delegate.call(this, atm, p__3754);
};
bound_coll.cljs$lang$maxFixedArity = 1;
bound_coll.cljs$lang$applyTo = (function (arglist__3759){
var atm = cljs.core.first(arglist__3759);
var p__3754 = cljs.core.rest(arglist__3759);
return bound_coll__delegate(atm, p__3754);
});
...
var map_bound__delegate = function (as,atm,p__3760){
var vec__3762 = p__3760;
var opts = cljs.core.nth.call(null,vec__3762,0,null);
...
var p__3760 = null;
if (goog.isDef(var_args)) {
  p__3760 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);
} 
return map_bound__delegate.call(this, as, atm, p__3760);
};
map_bound.cljs$lang$maxFixedArity = 2;
map_bound.cljs$lang$applyTo = (function (arglist__3763){
var as = cljs.core.first(arglist__3763);
var atm = cljs.core.first(cljs.core.next(arglist__3763));
var p__3760 = cljs.core.rest(cljs.core.next(arglist__3763));
return map_bound__delegate(as, atm, p__3760);
});
...
{return G__3765.crate$binding$bindable$;
}
})()))
{return true;
} else
{if((!G__3765.cljs$lang$protocol_mask$partition$))
{return cljs.core.type_satisfies_.call(null,crate.binding.bindable,G__3765);
} else
{return false;
}
}
...
{return G__3767.crate$binding$bindable_coll$;
}
})()))
{return true;
} else
{if((!G__3767.cljs$lang$protocol_mask$partition$))
{return cljs.core.type_satisfies_.call(null,crate.binding.bindable_coll,G__3767);
} else
{return false;
}
}
...
var G__3769 = atm;
if(G__3769)
{if((function (){var or__3824__auto__ = (G__3769.cljs$lang$protocol_mask$partition0$ & 32768);
if(or__3824__auto__)
{return or__3824__auto__;
} else
{return G__3769.cljs$core$IDeref$;
}
})())
{return true;
} else
{if((!G__3769.cljs$lang$protocol_mask$partition0$))
{return cljs.core.type_satisfies_.call(null,cljs.core.IDeref,G__3769);
} else
{return false;
}
}
...
var bound__delegate = function (atm,p__3770){
var vec__3772 = p__3770;
var func = cljs.core.nth.call(null,vec__3772,0,null);
...
var p__3770 = null;
if (goog.isDef(var_args)) {
  p__3770 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);
} 
return bound__delegate.call(this, atm, p__3770);
};
bound.cljs$lang$maxFixedArity = 1;
bound.cljs$lang$applyTo = (function (arglist__3773){
var atm = cljs.core.first(arglist__3773);
var p__3770 = cljs.core.rest(arglist__3773);
return bound__delegate(atm, p__3770);
});
