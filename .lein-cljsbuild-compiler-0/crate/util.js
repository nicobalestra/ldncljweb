...
var G__3809__delegate = function (x,xs){
return (function (s,more){
while(true){
if(cljs.core.truth_(more))
{{
var G__3810 = [cljs.core.str(s),cljs.core.str(as_str.call(null,cljs.core.first.call(null,more)))].join('');
var G__3811 = cljs.core.next.call(null,more);
s = G__3810;
more = G__3811;
continue;
}
...
var G__3809 = function (x,var_args){
var xs = null;
if (goog.isDef(var_args)) {
  xs = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);
} 
return G__3809__delegate.call(this, x, xs);
};
G__3809.cljs$lang$maxFixedArity = 1;
G__3809.cljs$lang$applyTo = (function (arglist__3812){
var x = cljs.core.first(arglist__3812);
var xs = cljs.core.rest(arglist__3812);
return G__3809__delegate(x, xs);
});
...
return clojure.string.join.call(null,"&",(function (){var iter__2470__auto__ = (function iter__3817(s__3818){
return (new cljs.core.LazySeq(null,false,(function (){
var s__3818__$1 = s__3818;
while(true){
if(cljs.core.seq.call(null,s__3818__$1))
{var vec__3820 = cljs.core.first.call(null,s__3818__$1);
var k = cljs.core.nth.call(null,vec__3820,0,null);
var v = cljs.core.nth.call(null,vec__3820,1,null);
return cljs.core.cons.call(null,[cljs.core.str(crate.util.url_encode_component.call(null,k)),cljs.core.str("="),cljs.core.str(crate.util.url_encode_component.call(null,v))].join(''),iter__3817.call(null,cljs.core.rest.call(null,s__3818__$1)));
} else
{return null;
}
break;
...
url.cljs$lang$applyTo = (function (arglist__3821){
