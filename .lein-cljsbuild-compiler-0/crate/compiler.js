...
var G__3687 = cljs.core.seq.call(null,content);
while(true){
if(G__3687)
{var c = cljs.core.first.call(null,G__3687);
...
cljs.core._add_method.call(null,crate.compiler.dom_binding,"\uFDD0'attr",(function (_,p__3689,elem){
...
cljs.core._add_method.call(null,crate.compiler.dom_binding,"\uFDD0'style",(function (_,p__3691,elem){
var vec__3692 = p__3691;
var k = cljs.core.nth.call(null,vec__3692,0,null);
var b = cljs.core.nth.call(null,vec__3692,1,null);
return crate.binding.on_change.call(null,b,(function (v){
...
var pred__3693 = cljs.core._EQ_;
var expr__3694 = type;
if(pred__3693.call(null,"\uFDD0'add",expr__3694))
{return crate.compiler.dom_add.call(null,bc,parent,elem,v);
} else
{if(pred__3693.call(null,"\uFDD0'remove",expr__3694))
{return crate.compiler.dom_remove.call(null,bc,elem);
} else
{throw (new Error([cljs.core.str("No matching clause: "),cljs.core.str(expr__3694)].join('')));
}
}
}));
}));
crate.compiler.handle_bindings = (function handle_bindings(bs,elem){
var G__3698 = cljs.core.seq.call(null,bs);
while(true){
if(G__3698)
{var vec__3699 = cljs.core.first.call(null,G__3698);
var type = cljs.core.nth.call(null,vec__3699,0,null);
var b = cljs.core.nth.call(null,vec__3699,1,null);
crate.compiler.dom_binding.call(null,type,b,elem);
{
var G__3700 = cljs.core.next.call(null,G__3698);
G__3698 = G__3700;
continue;
}
} else
...
{var G__3703 = cljs.core.seq.call(null,v);
while(true){
if(G__3703)
{var vec__3704 = cljs.core.first.call(null,G__3703);
var k = cljs.core.nth.call(null,vec__3704,0,null);
var v__$1 = cljs.core.nth.call(null,vec__3704,1,null);
dom_style.call(null,elem,k,v__$1);
{
var G__3705 = cljs.core.next.call(null,G__3703);
G__3703 = G__3705;
continue;
}
} else
...
{var G__3708 = cljs.core.seq.call(null,attrs);
while(true){
if(G__3708)
{var vec__3709 = cljs.core.first.call(null,G__3708);
...
var vec__3723 = (function (){var vec__3724 = clojure.string.split.call(null,tag__$1,/:/);
...
return elem;
}finally {crate.compiler.bindings = bindings3728;
}});
/**
